...
urlpatterns=[
    ...
    path('user_update/<int:pk>/', views.UserAccountUpdateView.as_view(), name='name'),
    path('user_delete/<int:pk>', views.UserAccountDeleteView.as_view(), name='user-delete'),
    
    # user address
    path('all-address-details/', views.UserAddressessListView.as_view(), name='all address-details'),
    path('address-details/<int:pk>', views.UserAddressDetailsView.as_view(), name= 'user-address-details'),
